            ...
            <div class="col-12">
                <div class="card card-primary">
                    ...
                    <form action="?act=sua-khach-hang" method="POST">
                        <input type="hidden" name="khach_hang_id" value="<?=$khachHang['ho_ten'] ?>">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="gioi_tinh" id="inputStatus" class="form-control custom-select">
                                 ...
                                 <option <?= $khachHang['gioi_tinh'] !== 1 ? 'selected': '' ?> value="1">Nữ</option>
                                </select>

                            </div>
                            <div class="form-group">
                                <label>Địa chỉ</label>
                                <input type="text" class="form-control" name="dia_chi" value="<?=$khachHang['dia_chi'] ?>" placeholder="Nhập số đia chỉ">
                            ...
                            <div class="form-group">
                                ...
                                <select name="trang_thai" id="inputStatus" class="form-control custom-select">
                                 ...
                                 <option <?= $khachHang['trang_thai'] !== 1 ? 'selected': '' ?> value="1">Inactive</option>
                                </select>
                            </div>                            
                        </div>
