                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <p>Chúng tôi cam kết mang đến những sản phẩm an toàn, hiệu quả từ các thương hiệu uy tín, phù hợp với mọi nhu cầu làm đẹp của bạn </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            <h6 class="widget-title">Liên Hệ<iframe src="" frameborder="0"></iframe></h6>
                            <div class="widget-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2024<b>NBH</b> Made in <i class="fa fa-heart text-danger"></i> VietNam</p>
                        </div>
                    </div>
                </div>
            </div>
