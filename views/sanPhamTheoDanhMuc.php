            ...
            <div class="row">
                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    <aside class="sidebar-wrapper">
                        ...
                        <div class="sidebar-single">
                            <h5 class="sidebar-title">
                                <a class="sidebar-single text-danger"
                                    href="<?= BASE_URL . '?act=san-pham-theo-danh-muc' ?>">Top 10
                                    Sản Phẩm</a>
                            </h5>
                                            ...
                                            <li>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        id="customCheck111">
                                                    <label class="custom-control-label" for="customCheck111">S
                                                        (4)</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        id="customCheck222">
                                                    <label class="custom-control-label" for="customCheck222">M
                                                        (5)</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        id="customCheck333">
                                                    <label class="custom-control-label" for="customCheck333">L
                                                        (7)</label>
                                                </div>
                                            </li>
                                            <li>
                                    ...
                                    <figure class="product-thumb">
                                        <a href="<?= BASE_URL . '?act=san-phams&hinh_anh' ?>">
                                            ...
                                            <img class="pri-img" src="<?= BASE_URL . $sanPham['hinh_anh'] ?>"
                                                alt="product" width="200px" height="200px">
